      ...
      <tr>
        ...
        <td>
          ...
          <form method="post" style="display:inline-flex;gap:6px">
            ...
            <button name="withdraw_action" value="approve" class="btn btn-sm" style="background:#16a34a;color:#fff" onclick="return confirm('确认打款 ¥<?=$w['amount']?>?')">通过</button>
            <button name="withdraw_action" value="reject" class="btn btn-sm" style="background:#fee2e2;color:#dc2626" onclick="return confirm('确认驳回并退回余额?')">驳回</button>
          </form>
