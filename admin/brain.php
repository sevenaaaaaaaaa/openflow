...
$digest = growth_brain_digest(is_array($rows) ? $rows : [], $truth, 25);
    ...
    <div style="display:flex;flex-direction:column;gap:10px">
      ...
      <div class="card" style="padding:14px 16px;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
        ...
        <div style="flex:1;min-width:220px">
          <div style="font-weight:700;font-size:14px;margin-bottom:2px"><?=brain_badge($b['module'])?> <?=htmlspecialchars($b['action'])?></div>
