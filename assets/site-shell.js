...
(() => {
  // src/lib/dialog.ts
  function createDialogRegistry(effects = {}) {
    ...
    function setLock(next) {
      ...
      locked = next;
      (_a = effects.onLock) == null ? void 0 : _a.call(effects, next);
    }
    function activate(h) {
      var _a, _b;
      current = h;
      setLock(true);
      h.open();
      (_a = effects.onBroadcast) == null ? void 0 : _a.call(effects, "open", h);
      (_b = effects.onOpened) == null ? void 0 : _b.call(effects, h);
    }
    function deactivate(h) {
      var _a, _b;
      h.close();
      current = null;
      setLock(false);
      (_a = effects.onBroadcast) == null ? void 0 : _a.call(effects, "close", h);
      (_b = effects.onClosed) == null ? void 0 : _b.call(effects, h);
    }
    const registry = {
      register(handle) {
      ...
      open(id) {
        ...
        if (current) {
          ...
          prev.close();
          current = null;
          (_a = effects.onBroadcast) == null ? void 0 : _a.call(effects, "close", prev);
          (_b = effects.onClosed) == null ? void 0 : _b.call(effects, prev);
        }
        activate(h);
        return true;
      },
      ...
      handleClick(e) {
        ...
        if (e.target === h.el && h.selfIsScrim) {
          registry.close(h.id);
          return true;
        }
        return false;
  ...
  function filterCommands(items, query) {
    ...
    items.forEach((item, idx) => {
      ...
      const keys = ((_a = item.keywords) != null ? _a : []).map(norm);
      let score = 0;
  ...
  function moveIndex(current, len, delta) {
    if (len <= 0) return -1;
    const next = (current + delta) % len;
    return next < 0 ? next + len : next;
  }
  function shouldScrollIntoView(index, visibleFrom, visibleTo) {
  ...
  (function() {
    ...
    (function() {
      ...
      function send(payload) {
        if (navigator.sendBeacon) {
          ...
          navigator.sendBeacon(REPORT, fd);
          return;
        }
      ...
      window.addEventListener("error", function(e) {
        ...
        var now = Date.now();
        if (lastErr[msg] && now - lastErr[msg] < 1e4) return;
        lastErr[msg] = now;
        send({ type: "error", page: location.pathname, msg });
      });
      window.addEventListener("load", function() {
        try {
          var lt = Math.round(performance.timing.loadEventEnd - performance.timing.navigationStart);
          if (lt > 500) send({ type: "perf", page: location.pathname, load_ms: lt });
        } catch (e) {
        }
      });
    })();
    ...
    if (!document.getElementById("of-fonts-css")) {
      ...
      lf.id = "of-fonts-css";
      lf.rel = "stylesheet";
      lf.href = "/assets/fonts/fonts.css?v=20260909a";
    ...
    if (!document.getElementById("of-tokens-css")) {
      ...
      l1.id = "of-tokens-css";
      l1.rel = "stylesheet";
      l1.href = "/assets/tokens.css?v=20260909a";
      document.head.appendChild(l1);
    }
    if (!document.getElementById("of-modules-css")) {
      var l2 = document.createElement("link");
      l2.id = "of-modules-css";
      l2.rel = "stylesheet";
      l2.href = "/assets/modules.css?v=20260909a";
    ...
    var NAV_FALLBACK = [
      { id: "home", label: "首页", href: "/", icon: "home" },
      {
        ...
        mega: {
          title: "产品",
          blurb: "芭乐派增长操作系统 · 帮一人公司设计 Agent 能跑的增长系统",
          cols: [
            { head: "它是怎么工作的", items: [
      ...
      },
      {
        ...
        mega: {
          title: "能力 · TIPS 框架",
          blurb: "触达 / 洞察 / 个性化 / 销售 四力合一，加上行动脊柱、增长引擎与开源",
          cols: [
            { head: "四力", items: [
      ...
      },
      {
        ...
        mega: {
          title: "课程 · 学习路径",
          blurb: "New-1~4 基石课 + R.B.E 训练营 · 以 OpenFlow 为工具",
          cols: [
            { head: "课程", items: [
      ...
      },
      {
        ...
        mega: {
          title: "学院",
          blurb: "增长系统 · Agent · 一人公司方法论，读、下、听、练",
          cols: [
            { head: "内容", items: [
      ...
      { id: "pricing", label: "定价", href: "/pricing", icon: "doc" },
      { id: "about", label: "关于", href: "/about", icon: "info" }
    ];
    var LEGACY = {
      "/category/products/cms": "/product#feat-canvas",
      "/category/products/ma": "/product#feat-canvas",
      "/category/products/cdp": "/capability#cap-insight",
      "/category/products/seo": "/capability#cap-touch",
      "/category/products/crm": "/capability#cap-sales",
      "/category/products/commerce": "/capability#cap-sales",
      "/category/products/community": "/community",
      "/category/products/data": "/capability#cap-insight",
      "/category/capabilities/content": "/capability#cap-touch",
      "/category/capabilities/growth": "/capability#cap-touch",
      "/category/capabilities/conversion": "/capability#cap-personality",
      "/category/capabilities/data": "/capability#cap-insight",
      "/category/capabilities/commerce": "/capability#cap-sales",
      "/category/capabilities/community": "/community",
      "/category/courses/big": "/courses?f=基石#catalog",
      "/category/courses/series": "/courses#catalog",
      "/category/courses/column": "/articles",
      "/category/courses/live": "/events",
      "/category/courses/free": "/downloads",
      "/category/academy/articles": "/articles",
      "/category/academy/downloads": "/downloads",
      "/category/academy/podcasts": "/podcasts",
      "/category/academy/topics": "/topics",
      "/category/academy/docs": "/docs",
      "/category/academy/tools": "/tools",
      "/category/marketplace/skills": "/marketplace?type=skill",
      "/category/marketplace/plugins": "/marketplace?type=plugin",
      "/category/marketplace/themes": "/marketplace?type=theme",
      "/category/marketplace/forum": "/community",
      "/xmp/api-docs": "/docs#api",
      "/md-docs/DEVELOPER.md": "/docs?doc=DEVELOPER",
      "https://github.com/balepai/openflow": "https://github.com/sevenaaaaaaaaa/openflow"
    };
    function fixHref(h) {
    ...
    function fixNav(list) {
      list.forEach(function(n) {
        ...
        if (n.mega) {
          (n.mega.cols || []).forEach(function(c) {
            (c.items || []).forEach(function(it) {
              it.href = fixHref(it.href);
            });
          });
          (n.mega.foot || []).forEach(function(f) {
            f.href = fixHref(f.href);
          });
        }
      });
      return list;
    ...
    var BRAND_SVG = '<svg viewBox="0 0 64 64" fill="none" aria-hidden="true"><defs><linearGradient id="ofg-b" x1="12" y1="52" x2="54" y2="8" gradientUnits="userSpaceOnUse"><stop stop-color="#2563eb"/><stop offset="1" stop-color="#7c5cff"/></linearGradient></defs><path d="M46.7 48.3 A22 22 0 1 1 46.7 15.7" stroke="url(#ofg-b)" stroke-width="7" stroke-linecap="round"/><path d="M40.5 13.4 L52.7 9.0 L49.6 21.6" stroke="url(#ofg-b)" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/></svg>';
    function g(id) {
    ...
    function mount() {
      ...
      header.id = "chrome";
      header.innerHTML = '<div class="bar"><div class="bar-start"><div class="lights" aria-hidden="true"><span class="light light-r"></span><span class="light light-y"></span><span class="light light-g"></span></div><a class="brand" href="/" aria-label="OpenFlow 首页"><span class="ic">' + BRAND_SVG + '</span><span>OpenFlow<span class="bn-sub">GROWTH OS</span></span></a></div><nav class="tabs" id="tabs" role="navigation" aria-label="站点导航"></nav><div class="controls"><button class="cbtn" id="btn-menu" aria-label="打开导航" aria-expanded="false"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h16M4 12h16M4 17h16"/></svg></button><button class="kbd-chip" id="btn-cmd" aria-label="打开命令面板"><span class="ic">' + I.search + '</span><span>搜索与命令</span><span class="kbd">⌘ K</span></button><button class="cbtn" id="btn-theme" aria-label="切换主题"></button><button class="avatar anon" id="btn-av" aria-label="登录 / 注册"></button></div><div class="drop" id="drop"><div class="drop-head"><div class="drop-av" id="dropAv">?</div><div style="min-width:0"><div class="drop-name" id="dropName"></div><div class="drop-mail" id="dropMail"></div></div></div><button class="drop-item" id="dropProfile">' + ic("users") + '<b>个人中心</b></button><button class="drop-item danger" id="dropLogout">' + ic("info") + "<b>退出登录</b></button></div></div>";
      document.body.insertBefore(header, document.body.firstChild);
      if (!document.getElementById("of-blobs")) {
        var blobs = document.createElement("div");
        blobs.className = "of-blobs";
        blobs.id = "of-blobs";
      ...
      ui.innerHTML = '<div class="scrim" id="scrim"></div><div class="overlay" id="palOverlay"></div><div class="palette" id="palette" role="dialog" aria-modal="true" aria-label="命令面板" data-of-dialog><input id="palInput" placeholder="搜索页面或命令…" autocomplete="off"><div class="p-list" id="palList"></div></div><div id="toasts" aria-live="polite"></div><div class="modal" id="authModal" role="dialog" aria-modal="true" aria-label="登录" data-of-dialog><div class="mbox"><div class="mhead"><h3 id="authTitle">登录 OpenFlow</h3><button class="mx" data-close="authModal" aria-label="关闭"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg></button></div><div class="mbody"><div class="auth-tabs"><button type="button" class="auth-tab on" id="tabLogin">登录</button><button type="button" class="auth-tab" id="tabReg">注册</button></div><div id="regFields" style="display:none"><div class="field"><label for="fNick">昵称</label><input class="inp" id="fNick" placeholder="2-20 个字符" autocomplete="nickname"></div></div><div class="field"><label for="fMail">邮箱</label><input class="inp" id="fMail" placeholder="you@example.com" type="email" autocomplete="email"></div><div class="field"><label for="fPwd">密码</label><input class="inp" id="fPwd" placeholder="至少 6 位" type="password" autocomplete="current-password"></div><div class="field" id="capRow" style="display:none"><label for="fCap">邮箱验证码</label><div style="display:flex;gap:8px"><input class="inp" id="fCap" placeholder="6 位验证码" inputmode="numeric" autocomplete="one-time-code" style="flex:1"><button type="button" class="btn ghost" id="capSend" style="flex:0 0 auto;white-space:nowrap">发送验证码</button></div></div><div class="err" id="authErr" role="alert"></div><button type="button" class="btn primary" id="authSubmit" style="width:100%">登录</button><p class="auth-foot">登录即开通 OpenFlow 社区账号，课程与社区内容跨站同步。</p></div></div></div><div class="modal" id="profileModal" role="dialog" aria-modal="true" aria-label="个人中心" data-of-dialog><div class="mbox"><div class="mhead"><h3>个人中心</h3><button class="mx" data-close="profileModal" aria-label="关闭"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M6 6l12 12M18 6 6 18"/></svg></button></div><div class="mbody"><div style="display:flex;align-items:center;gap:14px;margin-bottom:4px"><div class="drop-av" id="pfAv">?</div><div style="min-width:0"><div class="drop-name" id="pfName"></div><div class="drop-mail" id="pfMail"></div></div></div><div class="p-stat"><a class="ps" href="/account?view=courses"><div class="pv" id="pfC1">0</div><div class="pl">我的课程</div></a><a class="ps" href="/account?view=orders"><div class="pv" id="pfC2">0</div><div class="pl">我的订单</div></a><a class="ps" href="/consultation?view=my"><div class="pv" id="pfC3">0</div><div class="pl">我的咨询</div></a></div><a class="drop-item" href="/messages" style="border-top:1px solid var(--border-soft);margin-top:2px"><span class="ic">' + I.doc + '</span><span>站内信</span><span id="pfUnread" style="margin-left:auto;background:var(--danger-soft);color:var(--danger);font-size:11px;padding:1px 7px;border-radius:999px;display:none">0</span></a><a class="drop-item" href="/account" style="border-bottom:1px solid var(--border-soft);margin-bottom:2px"><span class="ic">' + I.users + '</span><span>完整个人中心</span><span style="margin-left:auto;color:var(--faint);font-size:11px">→</span></a><a class="drop-item" id="pfOrg" href="/enterprise" style="border-bottom:1px solid var(--border-soft);margin-bottom:2px"><span class="ic">' + I.box + '</span><span>申请商业版</span><span style="margin-left:auto;color:var(--faint);font-size:11px">→</span></a><div class="set-row"><div><div class="st2">深色主题</div><div class="sd">跟随你的偏好</div></div><div class="switch" id="setTheme" role="switch" aria-checked="false" tabindex="0"></div></div><div class="set-row"><div><div class="st2">减少动效</div><div class="sd">关闭动画与过渡</div></div><div class="switch" id="setRM" role="switch" aria-checked="false" tabindex="0"></div></div><button type="button" class="btn ghost" id="pfLogout" style="width:100%;margin-top:14px;color:var(--danger);border-color:var(--danger)">退出登录</button></div></div></div>';
      ...
      mega.setAttribute("aria-label", "子导航");
      ...
      function megaHtml(m) {
        ...
        (m.foot || []).forEach(function(f) {
          html += '<a href="' + esc(f.href) + '">' + esc(f.t) + "</a>";
        });
        html += '</div></div><div class="mg-cols">';
        (m.cols || []).forEach(function(col) {
          html += '<div class="mg-col"><div class="mg-head">' + esc(col.head) + "</div>";
          (col.items || []).forEach(function(it) {
            html += '<a class="link-it" href="' + esc(it.href) + '"><span class="lt"><b>' + esc(it.t) + "</b><span>" + esc(it.d) + "</span></span>" + GO + "</a>";
          });
          html += "</div>";
        });
        return html + "</div>";
      ...
      function megaPlace() {
        if (!megaTab) return;
        var chrome2 = g("chrome"), cr = chrome2.getBoundingClientRect(), tr = megaTab.getBoundingClientRect();
      ...
      function megaOpen(tab) {
        ...
        if (megaTab) {
          megaTab.classList.remove("mega-open");
          megaTab.setAttribute("aria-expanded", "false");
        }
        megaTab = tab;
        tab.classList.add("mega-open");
      ...
      function megaCloseSoon() {
        clearTimeout(megaTimer);
        megaTimer = setTimeout(megaClose, 180);
      }
      ...
      tabs.querySelectorAll(".tab").forEach(function(t) {
        ...
        t.addEventListener("keydown", function(e) {
          if (e.key === "ArrowDown" || e.key === "Enter" && e.altKey) {
            e.preventDefault();
            megaOpen(t);
            var f = mega.querySelector(".link-it") || mega.querySelector("a");
            if (f) f.focus();
          }
      ...
      mega.addEventListener("focusout", function(e) {
        if (!mega.contains(e.relatedTarget) && !(megaTab && megaTab === e.relatedTarget)) megaCloseSoon();
      });
      window.addEventListener("scroll", function() {
        if (mega.classList.contains("open")) megaClose();
      }, { passive: true });
      window.addEventListener("resize", function() {
        if (mega.classList.contains("open")) megaPlace();
      });
      document.addEventListener("click", function(e) {
        if (mega.classList.contains("open") && !mega.contains(e.target) && !(megaTab && megaTab.contains(e.target))) megaClose();
      });
      var sb = document.createElement("aside");
      sb.id = "sidebar";
      var sbHtml = '<div class="ws" id="ws"><span class="ic">' + BRAND_SVG + "</span><b>Open Flow · " + PAGE_LABEL + '</b></div><div id="sbExtra"></div><div id="sbContext"></div><div class="sec-title" id="sbNavSec"><span>站点</span></div><div id="sbNav"></div><div class="sec-title"><span>账户</span></div><button class="drop-item" id="drawer-auth"><span class="ic">' + I.users + '</span><b id="drawer-auth-label">登录 / 注册</b></button><div class="sb-foot"><button id="sb-toggle" aria-label="折叠侧栏" title="折叠侧栏"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="16" rx="2.5"/><path d="M9 4v16"/></svg></button></div>';
      sb.innerHTML = sbHtml;
      ...
      NAV.forEach(function(n) {
        ...
        if (n.mega && n.mega.cols) {
          ...
          btn.className = "s-more";
          btn.type = "button";
          btn.setAttribute("aria-expanded", "false");
          btn.setAttribute("aria-label", "展开 " + n.label + " 子导航");
          ...
          n.mega.cols.forEach(function(col) {
            (col.items || []).forEach(function(it) {
              subHtml += '<a href="' + it.href + '"><b>' + it.t + "</b><span>" + it.d + "</span></a>";
            });
          });
      ...
      (function mountSidebarContext() {
        function fill() {
          ...
          try {
            document.dispatchEvent(new CustomEvent("of:sb-context"));
          } catch (e) {
          }
        }
        if (document.readyState === "loading") document.addEventListener("DOMContentLoaded", fill);
        ...
        var guard = function() {
          ...
          for (var i = 0; i < sheets.length && !found; i++) {
            ...
            for (var j = 0; j < rules.length; j++) {
              if (rules[j].selectorText && rules[j].selectorText.indexOf(".of-shell-body") > -1) {
                found = true;
                break;
              }
            }
          ...
          st.textContent = "body.of-shell-body{margin-left:var(--content-l,calc(var(--sb-w,248px) + 34px));padding:calc(30px + var(--external-top-inset,0px)) var(--gx,clamp(16px,4vw,40px)) 64px;transition:margin-left .45s var(--ease-spring)}@media(max-width:960px){body.of-shell-body{margin-left:0;padding-left:14px;padding-right:14px}}";
      ...
      function sbOpen(v) {
        document.body.dataset.sb = v ? "drawer" : S.sb || "full";
      ...
      sbToggle.addEventListener("click", function() {
        ...
        var i = sbOrder.indexOf(cur);
        if (i < 0) i = 0;
        sbSet(sbOrder[(i + 1) % 3]);
      });
      menuBtn.addEventListener("click", function() {
        if (!matchMedia("(max-width:960px)").matches && document.body.dataset.sb === "closed") {
          sbSet("full");
          return;
        }
      ...
      sbNav.querySelectorAll("a").forEach(function(a) {
      ...
      (function mountScrollState() {
        ...
        function syncPhase() {
          setPhase((window.scrollY || document.documentElement.scrollTop || 0) > DOCK_AT);
        }
        syncPhase();
        if ("IntersectionObserver" in window) {
          new IntersectionObserver(function(en) {
            setPhase(!en[0].isIntersecting);
          }).observe(sentinel);
        } else {
      ...
      function setUser(u) {
        S.user = u || null;
        try {
          if (u) localStorage.setItem(SK, u.email);
      ...
      try {
        ...
        if (sess && !S.user) {
          S.user = { email: sess, nick: sess.split("@")[0] };
        }
      } catch (e) {
      }
      function toast(txt) {
      ...
      if (!hasMark && !curUser()) {
        ...
        fetch("/api/member?action=profile_summary", { method: "POST", headers: { "Accept": "application/json" }, credentials: "same-origin" }).then(function(r) {
          ...
          if (res.http === 200 && d.ok) {
            var cu = curUser();
            if (!cu || cu.email !== d.email || cu.nick !== d.name) setUser({ email: d.email || cu && cu.email || "", nick: d.name || "" });
          } else if (res.http === 401) {
            document.cookie = "of_lm=; Max-Age=0; path=/";
            if (curUser()) setUser(null);
          }
        }).catch(function() {
        });
      ...
      g("dropProfile").addEventListener("click", function() {
      ...
      function logout() {
        ...
        return fetch("/api/member", { method: "POST", body: fd, credentials: "same-origin" }).catch(function() {
        }).then(function() {
          setUser(null);
          toast("已退出登录");
        });
      }
      g("dropLogout").addEventListener("click", function() {
        drop.classList.remove("open");
        logout();
      });
      g("drawer-auth").addEventListener("click", function() {
        if (curUser()) openProfile();
        else openAuth("login");
      });
      document.addEventListener("click", function(e) {
      ...
      function openAuth(mode) {
        ...
        setTimeout(function() {
          var f = authModal.querySelector("#fMail");
          if (f) f.focus();
        }, 30);
      }
      function closeAuth() {
        authModal.classList.remove("open");
        g("authErr").classList.remove("show");
        lockScroll(false);
        if (lastFocus) lastFocus.focus();
      }
      function setAuthMode(m) {
        var login = m === "login";
        g("tabLogin").classList.toggle("on", login);
        g("tabReg").classList.toggle("on", !login);
      ...
      g("tabLogin").addEventListener("click", function() {
        setAuthMode("login");
      });
      g("tabReg").addEventListener("click", function() {
        setAuthMode("register");
      });
      authModal.addEventListener("keydown", function(e) {
        if (authModal.classList.contains("open")) trapFocus(authModal, e);
      });
      g("authSubmit").addEventListener("click", function() {
        ...
        if (reg && (nick.length < 2 || nick.length > 20)) {
          err.textContent = "昵称需 2-20 个字符";
          err.classList.add("show");
          return;
        }
        ...
        btn.textContent = "处理中…";
        var fd = new FormData();
        fd.append("account", mail);
        fd.append("password", pwd);
        if (reg) {
          fd.append("name", nick);
          fd.append("email", mail);
          fd.append("captcha", g("fCap").value.trim());
        }
        fetch("/api/member?action=" + (reg ? "register" : "login"), { method: "POST", body: fd, headers: { "Accept": "application/json" } }).then(function(r) {
          return r.json().then(function(d) {
            return { http: r.status, d };
          }).catch(function() {
            return { http: 0, d: {} };
          ...
          if (res.http === 200 && d.ok) {
            ...
            closeAuth();
            toast(reg ? "注册成功，欢迎加入芭乐派" : "已登录，欢迎回来");
            openProfile();
          } else {
            if (d.need_captcha && g("capRow").style.display === "none") {
              g("capRow").style.display = "block";
              sendCaptcha(mail);
              setTimeout(function() {
                g("fCap").focus();
              }, 30);
      ...
      function sendCaptcha(mail) {
        var sb2 = g("capSend"), err = g("authErr");
        if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(mail)) {
          err.textContent = "请先填写有效的邮箱地址";
          err.classList.add("show");
          return;
        }
        sb2.disabled = true;
        sb2.textContent = "发送中…";
        var fd = new FormData();
        fd.append("target", mail);
        fetch("/api/member?action=send_captcha", { method: "POST", body: fd, headers: { "Accept": "application/json" } }).then(function(r) {
          ...
          if (d.ok) {
            ...
            var t = setInterval(function() {
              ...
              if (n <= 0) {
                clearInterval(t);
                sb2.disabled = false;
                sb2.textContent = "重新发送";
              } else sb2.textContent = n + "s";
            }, 1e3);
          } else {
            sb2.disabled = false;
            sb2.textContent = "发送验证码";
            err.textContent = d.error || "发送失败";
            err.classList.add("show");
          }
        }).catch(function() {
          sb2.disabled = false;
      ...
      g("capSend").addEventListener("click", function() {
        sendCaptcha(g("fMail").value.trim());
      });
      ...
      function openProfile() {
        ...
        g("pfC3").textContent = "…";
        var un = g("pfUnread");
        fetch("/api/member?action=profile_summary", { method: "POST", headers: { "Accept": "application/json" } }).then(function(r) {
          return r.json().catch(function() {
            return {};
          });
        }).then(function(d) {
          if (d && d.ok && d.stats) {
            ...
            if (un && (d.stats.unread || 0) > 0) {
              un.style.display = "inline";
              un.textContent = d.stats.unread;
            }
            var orgLink = g("pfOrg");
            if (orgLink && d.org) {
            ...
            g("pfC1").textContent = 0;
            g("pfC2").textContent = 0;
            g("pfC3").textContent = 0;
          }
        }).catch(function() {
          g("pfC1").textContent = 0;
          g("pfC2").textContent = 0;
        ...
        setTimeout(function() {
          var f = pfModal.querySelector(".mbox button,.mbox .switch");
          if (f) f.focus();
        }, 30);
      }
      function closePf() {
      ...
      g("setRM").addEventListener("click", function() {
        ...
        if (!on) window.__timers.forEach(function(t) {
          clearInterval(t);
        });
      });
      g("pfLogout").addEventListener("click", function() {
        closePf();
        logout();
      });
      pfModal.addEventListener("keydown", function(e) {
        if (pfModal.classList.contains("open")) trapFocus(pfModal, e);
      });
      ...
      var PAL_ITEMS = NAV.map(function(n) {
        return { label: n.label, href: n.href, icon: n.icon, keywords: n.keywords || [] };
      });
      var palActive = 0;
      var palShown = [];
      function renderPalette(query) {
        palShown = filterCommands(PAL_ITEMS, query || "");
        palActive = palShown.length ? 0 : -1;
        palList.innerHTML = "";
        if (!palShown.length) {
          var none = document.createElement("div");
          none.className = "p-none";
          none.textContent = "没有匹配的页面或命令";
          palList.appendChild(none);
          return;
        }
        palShown.forEach(function(it, i) {
          var a = document.createElement("a");
          a.className = "p-item" + (i === palActive ? " on" : "");
          a.href = it.href;
          a.innerHTML = ic(it.icon) + "<span>" + it.label + '</span><span class="p-hint">打开页面</span>';
      ...
      function setPalActive(i) {
        if (i < 0 || i >= palShown.length) return;
        palActive = i;
        var nodes = palList.querySelectorAll(".p-item");
        nodes.forEach(function(n, k) {
          n.classList.toggle("on", k === i);
        });
        var dir = shouldScrollIntoView(i, 0, 1);
        var act = nodes[i];
      ...
      function openPalette() {
        ...
        palOv.classList.add("open");
        palInput.value = "";
        palInput.focus();
      }
      function closePalette() {
        pal.classList.remove("open");
        palOv.classList.remove("open");
      }
      ...
      palInput.addEventListener("keydown", function(e) {
        ...
        if (e.key === "ArrowDown") {
          e.preventDefault();
          setPalActive(moveIndex(palActive, palShown.length, 1));
          return;
        }
        if (e.key === "ArrowUp") {
          e.preventDefault();
        ...
        if (e.key === "Enter") {
          var it = palShown[palActive] || palShown[0];
      ...
      (function() {
        ...
        var registry = createDialogRegistry({
          onLock: lock,
          onOpened: function(h) {
            restoreFocus = document.activeElement;
            var f = h.el.querySelector('input:not([type=hidden]),button:not([disabled]),a[href],[tabindex]:not([tabindex="-1"])');
          ...
          onBroadcast: function(kind, h) {
            if (kind !== "open") return;
            try {
              document.dispatchEvent(new CustomEvent("of:dialog-open", { detail: { el: h.el } }));
            } catch (e) {
            }
          }
        });
        document.addEventListener("keydown", function(e) {
          ...
          if (registry.handleEscape()) e.preventDefault();
        });
        document.addEventListener("click", function(e) {
          registry.handleClick({
            target: e.target,
            contains: function(node, t) {
        ...
        window.OFDialog = {
          ...
          register: function(el, name, opts) {
            if (!el || el.__ofReg) return;
            el.__ofReg = true;
            el.setAttribute("data-of-dialog", "");
            if (!el.getAttribute("role")) el.setAttribute("role", "dialog");
            if (!el.getAttribute("aria-modal")) el.setAttribute("aria-modal", "true");
            var baseOpen = opts && opts.open || function() {
              el.classList.add("open");
            };
            var baseClose = opts && opts.close || function() {
              el.classList.remove("open");
            };
            registry.register({
              id: name,
              el,
              selfIsScrim: el.getAttribute("data-scrim") !== "false",
              open: baseOpen,
              close: baseClose
            });
            ...
            el.__ofClose = function() {
              registry.close(name);
            };
          }
        };
        window.OFDialog.register(authModal, "auth", { open: function() {
          openAuth("login");
        }, close: closeAuth });
        window.OFDialog.register(g("profileModal"), "profile", { open: openProfile, close: closePf });
        var palEl = g("palette");
        palEl.setAttribute("data-scrim", "false");
        window.OFDialog.register(palEl, "palette", { open: openPalette, close: closePalette });
        window.OFShellDialogs = {
          openAuth: function() {
            authModal.__ofOpen && authModal.__ofOpen();
          },
          openProfile: function() {
            var e = g("profileModal");
            e && e.__ofOpen && e.__ofOpen();
          },
      ...
      (function mountFooterLanguage() {
        ...
        var active = locales.filter(function(l) {
          return l.id === current;
        })[0];
    ...
    function mountMotion() {
      ...
      all('[role="tablist"][data-tabs]').forEach(function(bar) {
        ...
        function byHash() {
          ...
          var hit = tabs.filter(function(t) {
            return t.id === h || t.getAttribute("aria-controls") === h || t.dataset.hash === h;
          })[0];
          if (hit) {
            sel(hit);
            var go = function() {
              var y = bar.getBoundingClientRect().top + window.scrollY - 88;
      ...
      if (bt) {
        ...
        var upd = function() {
          bt.classList.toggle("show", window.scrollY > 480);
        };
