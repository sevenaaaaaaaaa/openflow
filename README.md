...
**形态**：一套 PHP 后端，多端触达 —— Web 后台 / **PWA 可安装**（mac·win·linux·iPad·安卓pad·鸿蒙 浏览器安装）/ **CLI**（`bin/of`）/ **MCP**（agent 可调 30+ 工具）。
...
项目已经完成大部分业务器官和第一阶段连接工作，当前代码包含约 209 个后台入口、101 个 API 端点和 188 个核心模块。数量会随开发变化，以下以能力边界为准。
