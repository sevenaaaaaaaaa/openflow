...
const ADMIN_NAV_ALIAS = [
    ...
    'course-edit' => 'courses', 'course-students' => 'courses', 'customer-detail' => 'crm', 'profile-detail' => 'profiling', 'user-profile' => 'profiling', 'crm-lead-detail' => 'crm', 'person' => 'crm',
    ...
    $all = [
        ...
        [
            ...
            'subs' => [
                ...
                ['id' => 'agent-posts',     'label' => 'AI 岗位',          'href' => '/xmp/agent-posts', 'hint' => '常驻数字员工 · 每日交班'],
        ...
        ['id' => 'insight', 'label' => '洞察 Insight', 'short' => '洞察', 'icon' => $I['insight'], 'desc' => '分析 · 数据：看清发生了什么', 'groups' => [
            ['label' => '分析', 'items' => [
                ['label' => '运营分析', 'hint' => '实时 · 路径 · 传播 · 订阅', 'subs' => [
                    ...
                    ['id' => 'reports', 'label' => '自定义报表', 'perm' => 'analytics', 'hint' => '维度×指标×筛选+下钻'],
